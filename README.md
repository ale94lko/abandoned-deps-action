...
**Abandoned Dependencies Checker** solves this gap by auditing your manifest file (`package.json`), checking the source repository's actual activity via the GitHub REST API, and flagging packages that haven't received updates within your specified timeframe.
...
| --------------------- | ------------------------------------------------------------------------------- | --------------------- | -------- |
| `manifest-path`       | Path to your dependency manifest file.                                          | `package.json`        | `false`  |
